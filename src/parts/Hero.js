        ...
        <section className='mx-28 mt-5 p-4 font-poppins'>
            <div className='flex'>
                ...
                <div className='w-1/2 flex justify-center'>
                    <img src={ImageHero} alt="Bed with a books" className='absolute z-20 w-[24rem] mr-10 mb-10'/>
                    <img src={ImageHeroFrame} alt="Bed with a books frame" className='absolute z-10 w-[24rem] ml-10 mt-10' />
                </div>
            </div>
        </section>
    )
